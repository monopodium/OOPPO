...
echo "实验3：不同编码参数，写入1GB数据" >> oppo_project/test.result
...
echo "*******************************************" >> oppo_project/test.result
echo "10 5 3" >> oppo_project/test.result
sh exp.sh 1;sh exp.sh 1
cd ./oppo_project/cmake/build/
./run_coordinator
sleep 2
...
./run_coordinator
sleep 2
./run_client Best_Placement 10 5 3 1024
pkill -9 run_coordinator
cd ../../..
...
./run_coordinator
sleep 2
./run_client Best_Best_Placement 10 5 3 1024
pkill -9 run_coordinator
cd ../../..
...
./run_coordinator
sleep 2
./run_client Best_Placement 12 4 5 1024
pkill -9 run_coordinator
cd ../../..
...
./run_coordinator
sleep 2
./run_client Best_Best_Placement 12 4 5 1024
pkill -9 run_coordinator
cd ../../..
...
echo "*******************************************" >> oppo_project/test.result
echo "14 7 5" >> oppo_project/test.result
sh exp.sh 1;sh exp.sh 1
cd ./oppo_project/cmake/build/
./run_coordinator
sleep 2
...
./run_coordinator
sleep 2
./run_client Best_Placement 14 7 5 1024
pkill -9 run_coordinator
cd ../../..
...
./run_coordinator
sleep 2
./run_client Best_Best_Placement 14 7 5 1024
pkill -9 run_coordinator
cd ../../..
...
echo "*******************************************" >> oppo_project/test.result
echo "16 4 6" >> oppo_project/test.result
sh exp.sh 1;sh exp.sh 1
cd ./oppo_project/cmake/build/
./run_coordinator
sleep 2
...
./run_coordinator
sleep 2
./run_client Best_Placement 16 4 6 1024
pkill -9 run_coordinator
cd ../../..
...
./run_coordinator
sleep 2
./run_client Best_Best_Placement 16 4 6 1024
pkill -9 run_coordinator
cd ../../..
